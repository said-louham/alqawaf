        ...
        <div class="col-md-9">
            ...
            @foreach($attribute->attributeValue as $value)
                ...
                <div class="col-md-6">
                    ...
                    <input  type="number" step="any"  class="form-control" name="product_attribute_values[{{ $attribute->id }}][{{ $value->id }}][price]" id="price_{{ $attribute->id }}_{{ $value->id }}" value="{{ old('product_attribute_values.'.$attribute->id.'.'.$value->id.'.price') }}">
