                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectric" name="video_provider"
                                                        ...
                                                        <option value="youtube"
                                                            {{ old('video_provider') == 'youtube' ? 'selected' : ($product_language->product->video_provider == 'youtube' ? 'selected' : '') }}>
                                                            {{ __('Youtube') }}</option>
                                                        <option value="vimeo"
                                                            {{ old('video_provider') == 'vimeo' ? 'selected' : ($product_language->product->video_provider == 'vimeo' ? 'selected' : '') }}>
                                                            {{ __('Vimeo') }}</option>
                                                        <option value="mp4"
                                                            {{ old('video_provider') == 'mp4' ? 'selected' : ($product_language->product->video_provider == 'mp4' ? 'selected' : '') }}>
                                                            {{ __('Mp4') }}</option>
                                                    </select>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control select2 attribute-sets"
                                                    data-url="{{ route('edite-product-attribute-values') }}"
                                                    name="attribute_values[]" multiple>
                                                    @foreach ($attributes as $attribute)
                                                        attributes
                                                        <option value="{{ $attribute->id }}"
                                                            {{ old('attribute_values') ? (in_array($attribute->id, old('attribute_values')) ? 'selected' : '') : '' }}>
                                                            {{ $attribute->getTranslation('title', \App::getLocale()) }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                <p class="invalid-feedback text-info">
                                                    {{ __('N.B: Select Attribute  of this product to show attribute Product values') }}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="attribute-values">
                                            @php
                                                $attribute_values = old('attribute_values') ? old('attribute_values') : '';
                                                $attribute_values = $attributes->whereIn('id', $attribute_values);
                                            @endphp
